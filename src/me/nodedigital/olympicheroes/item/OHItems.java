...
//		emeraldInfused = addAttribute(emeraldInfused, "generic.attackDamage", 2, "mainhand");
...
//		items.add(emeraldInfused);
		...
		recurve = addAttribute(recurve, "generic.movementSpeed", .05, "offhand");
		...
		emeraldInfusedSword = addAttribute(emeraldInfusedSword, "generic.attackDamage", 8, "mainhand");
		emeraldInfusedSword = addAttribute(emeraldInfusedSword, "generic.attackSpeed", -2.4, "mainhand");
		...
		emeraldInfusedAxe = addAttribute(emeraldInfusedAxe, "generic.attackDamage", 10, "mainhand");
		emeraldInfusedAxe = addAttribute(emeraldInfusedAxe, "generic.attackSpeed", -3, "mainhand");
		...
		starPoweredSword = addAttribute(starPoweredSword, "generic.attackDamage", 10, "mainhand");
		starPoweredSword = addAttribute(starPoweredSword, "generic.attackSpeed", -2.4, "mainhand");
		...
		starPoweredAxe = addAttribute(starPoweredAxe, "generic.attackDamage", 12, "mainhand");
		starPoweredAxe = addAttribute(starPoweredAxe, "generic.attackSpeed", -3, "mainhand");
